var ROOTDM=[".beijing.gov.cn"],RECENDM=[],INCLUDESUBHOST=["www.beijing.gov.cn"],SHOWERRHOST=1,_wdUID="5",_wecl="//yhfx.beijing.gov.cn/1.gif";var _wdLP=location.protocol.indexOf('https')>-1?'https:':'http:';
...
function send_ref(surl) {
	...
	Aimg=new Image(1,1);Aimg.src=surl;
	Aimg.onload=_wdEC;
}
